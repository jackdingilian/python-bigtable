...
class TestExecuteQuery:
    ...
    def test_execute_query(self):
        ...
        with mock.patch.object(
            ...
            result = client.execute_query(self.PREPARED_STATEMENT)
    ...
    def test_execute_query_with_params(self):
        ...
        with mock.patch.object(
            ...
            result = client.execute_query(prepared_statement, parameters={"b": 9})
            results = [r for r in result]
...
class TestPrepareQuery:
    ...
    def test_prepare_query_no_params(self):
        """Test mutations with no errors"""
        expected_attempt_timeout = 19
        with self._make_client(project="project") as client:
            with mock.patch.object(client._gapic_client, "prepare_query") as mock_gapic:
                ...
                prepared_statement: PreparedStatement = client.prepare_statement(
                    "SELECT * FROM table",
                    "instance",
                    {},
                    app_profile_id="test",
    ...
    def test_prepare_query_with_all_valid_param_types(self):
        """Test mutations with no errors"""
        expected_attempt_timeout = 19
        with self._make_client(project="project") as client:
            with mock.patch.object(client._gapic_client, "prepare_query") as mock_gapic:
    ...
    def test_prepare_query_retryable_errors(self, retryable_exception):
        from google.api_core.exceptions import DeadlineExceeded
        from google.cloud.bigtable.data.exceptions import RetryExceptionGroup
    ...
    def test_prepare_query_rnon_retryable_errors(self, non_retryable_exception):
        with self._make_client(project="project") as client:
            with mock.patch.object(client._gapic_client, "prepare_query") as mock_gapic:
                mock_gapic.side_effect = non_retryable_exception("mock")
                with pytest.raises(non_retryable_exception):
                    client.prepare_statement(
                        "SELECT * FROM table", "instance", {}, app_profile_id="test"
                    )
