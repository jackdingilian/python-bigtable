...
class ExecuteQueryIteratorAsync:
    ...
    def __init__(
        ...
        protobuf_parameters: Dict[str, Value],
        ...
        self._app_profile_id = prepared_statement._app_profile_id()
        self._client = client
        self._instance_id = prepared_statement._instance_id()
        self._final_metadata = None
        self._latest_prepare_response = prepared_statement._prepare_query_response()
        ...
        self._request_body = {
            "instance_name": prepared_statement._instance_name(),
            "app_profile_id": prepared_statement._app_profile_id(),
            "prepared_query": self._latest_prepare_response._prepared_query(),
            "params": protobuf_parameters,
        }
    ...
    def _finalize_metadata(self) -> Metadata:
        ...
        This can't be set on init because the metadata can change due to plan refresh.
        ...
        """
        self._final_metadata = self._latest_prepare_response._metadata()
